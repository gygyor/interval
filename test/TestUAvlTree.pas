...
type
  ...
  published
    ...
    procedure TestSearchItemOrPrev;
...
procedure TestTAvlTree.TestSearchItemOrPrev;
begin
  FAvlTree.AddItem(58);
  FAvlTree.AddItem(51);
  FAvlTree.AddItem(1);
  ...
  CheckEquals(FAvlTree.SearchItemOrPrev(12).Key, 12);
  CheckEquals(FAvlTree.SearchItemOrPrev(11).Key, 1);
  CheckEquals(FAvlTree.SearchItemOrPrev(13).Key, 12);
  CheckEquals(FAvlTree.SearchItemOrPrev(14).Key, 12);
  CheckEquals(FAvlTree.SearchItemOrPrev(16).Key, 15);
  CheckEquals(FAvlTree.SearchItemOrPrev(51).Key, 51);
  CheckFalse(Assigned(FAvlTree.SearchItemOrPrev(0)));
end;
